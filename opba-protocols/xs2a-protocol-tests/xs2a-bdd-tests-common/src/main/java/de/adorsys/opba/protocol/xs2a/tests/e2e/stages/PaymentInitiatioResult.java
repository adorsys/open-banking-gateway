...
public class PaymentInitiatioResult extends Stage<PaymentInitiatioResult>  {
    ...
    @SneakyThrows
    @Transactional
    public PaymentInitiatioResult open_banking_has_consent_for_anton_brueckner_account_list() {
    ...
    @SneakyThrows
    @Transactional
    public PaymentInitiatioResult open_banking_has_no_consent() {
        assertThat(consents.findByServiceSessionId(UUID.fromString(serviceSessionId))).isEmpty();
        return self();
    }

    @Transactional
    public PaymentInitiatioResult open_banking_has_consent_for_max_musterman_account_list() {
        assertThat(consents.findByServiceSessionId(UUID.fromString(serviceSessionId))).isNotEmpty();
        return self();
    }
    ...
    @SneakyThrows
    @Transactional
    public PaymentInitiatioResult open_banking_has_consent_for_anton_brueckner_transaction_list() {
        assertThat(consents.findByServiceSessionId(UUID.fromString(serviceSessionId))).isNotEmpty();
        return self();
    }
    ...
    @SneakyThrows
    @Transactional
    public PaymentInitiatioResult open_banking_has_consent_for_max_musterman_transaction_list() {
        assertThat(consents.findByServiceSessionId(UUID.fromString(serviceSessionId))).isNotEmpty();
        return self();
    }

    @SneakyThrows
    public PaymentInitiatioResult open_banking_can_read_anton_brueckner_account_data_using_consent_bound_to_service_session() {
    ...
    @SneakyThrows
    public PaymentInitiatioResult open_banking_can_read_max_musterman_account_data_using_consent_bound_to_service_session() {
    ...
    @SneakyThrows
    public PaymentInitiatioResult open_banking_reads_anton_brueckner_transactions_using_consent_bound_to_service_session_data_validated_by_iban(
    ...
    public PaymentInitiatioResult open_banking_can_read_anton_brueckner_transactions_data_using_consent_bound_to_service_session(
        String resourceId, LocalDate dateFrom, LocalDate dateTo, String bookingStatus
    ) {
    ...
    @SneakyThrows
    public PaymentInitiatioResult open_banking_can_read_max_musterman_transactions_data_using_consent_bound_to_service_session(
        String resourceId, LocalDate dateFrom, LocalDate dateTo, String bookingStatus
    ) {
    ...
    @SneakyThrows
    public PaymentInitiatioResult open_banking_reads_max_musterman_transactions_using_consent_bound_to_service_session_data_validated_by_iban(
        String resourceId, LocalDate dateFrom, LocalDate dateTo, String bookingStatus
    ) {
    ...
    public PaymentInitiatioResult user_anton_brueckner_provided_initial_parameters_to_list_accounts_with_all_accounts_consent_and_gets_202() {
    ...
    public PaymentInitiatioResult fintech_calls_consent_activation_for_current_authorization_id() {
        withSignatureHeaders(RestAssured
                .given()
                    .header(SERVICE_SESSION_PASSWORD, SESSION_PASSWORD)
                    .contentType(MediaType.APPLICATION_JSON_VALUE), requestSigningService, OperationType.AIS)
                .when()
