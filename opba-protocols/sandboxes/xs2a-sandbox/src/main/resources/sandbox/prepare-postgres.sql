...
ALTER DEFAULT PRIVILEGES FOR USER testtpprest IN SCHEMA tpp GRANT ALL PRIVILEGES ON TABLES TO sandboxrole;
ALTER DEFAULT PRIVILEGES FOR USER testtpprest IN SCHEMA tpp GRANT ALL PRIVILEGES ON SEQUENCES TO sandboxrole;
