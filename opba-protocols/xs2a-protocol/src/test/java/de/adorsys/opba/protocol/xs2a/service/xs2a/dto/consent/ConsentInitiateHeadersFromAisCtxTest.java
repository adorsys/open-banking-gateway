...
public class ConsentInitiateHeadersFromAisCtxTest {
    ...
    public void consentInitiateHeadersFromAisCtxMapperTest() {
        // Given
        Xs2aAisContext mappingInput = utilService.getFromFile(PATH_PREFIX + "xs2a_ais_consent_input.json", Xs2aAisContext.class);
        ConsentInitiateHeaders expected = utilService.getFromFile(PATH_PREFIX + "xs2a_ais_consent_output.json", ConsentInitiateHeaders.class);
