...
@SpringBootTest(classes = ProvideScaChallengeResultBodyFromCtxTest.TestConfig.class)
public class ProvideScaChallengeResultBodyFromCtxTest {
    ...
    public void provideScaChallengeResultBodyFromCtxMapperTest() {
        ...
        ProvideScaChallengeResultBody expected = getFromFile(PATH_PREFIX + "xs2a_context_output.json", ProvideScaChallengeResultBody.class);
