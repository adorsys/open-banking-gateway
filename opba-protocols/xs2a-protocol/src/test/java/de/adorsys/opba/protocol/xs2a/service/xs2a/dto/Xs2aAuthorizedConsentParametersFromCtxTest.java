...
public class Xs2aAuthorizedConsentParametersFromCtxTest {
    ...
    public void xs2aAuthorizedConsentParametersFromCtxMapperTest() {
        // Given
        Xs2aContext mappingInput = utilService.getFromFile(PATH_PREFIX + "xs2a_consent_input.json", Xs2aContext.class);
        Xs2aAuthorizedConsentParameters expected = utilService.getFromFile(PATH_PREFIX + "xs2a_consent_output.json", Xs2aAuthorizedConsentParameters.class);
