...
public class AisConsentInitiateBodyFromCtxTest {
    ...
    public void aisConsentInitiateBodyMapperTest_non_empty_consent() {
        // Given
        Xs2aAisContext mappingInput = utilService.getFromFile(PATH_PREFIX + "ais_consent_non_empty_body_input.json", AccountListXs2aContext.class);
        AisConsentInitiateBody expected = utilService.getFromFile(PATH_PREFIX + "ais_consent_non_empty_body_output.json", AisConsentInitiateBody.class);
    ...
    public void aisConsentInitiateBodyMapperTest_empty_consent() {
        // Given
        Xs2aAisContext mappingInput = utilService.getFromFile(PATH_PREFIX + "ais_consent_empty_body_input.json", AccountListXs2aContext.class);
        AisConsentInitiateBody expected = utilService.getFromFile(PATH_PREFIX + "ais_consent_empty_body_output.json", AisConsentInitiateBody.class);
