...
public class Xs2aListTransactionsEntrypointFromRequestTest {
    ...
    public void xs2aListTransactionsEntrypointFromRequestMapperTest() {
        // Given
        ListTransactionsRequest mappingInput = utilService.getFromFile(PATH_PREFIX + "list_transactions_request_input.json", ListTransactionsRequest.class);
        TransactionListXs2aContext expected = utilService.getFromFile(PATH_PREFIX + "list_transactions_request_output.json", TransactionListXs2aContext.class);
