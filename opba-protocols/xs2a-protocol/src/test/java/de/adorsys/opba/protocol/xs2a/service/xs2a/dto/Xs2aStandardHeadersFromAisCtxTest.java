...
@SpringBootTest(classes = Xs2aStandardHeadersFromAisCtxTest.TestConfig.class)
public class Xs2aStandardHeadersFromAisCtxTest {
    ...
    public void xs2aStandardHeadersFromAisCtxMapperTest() {
        ...
        Xs2aStandardHeaders expected = getFromFile(PATH_PREFIX + "xs2a_consent_output.json", Xs2aStandardHeaders.class);
