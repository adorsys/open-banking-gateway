...
public enum AccountTypeTO {
  ...
  CPAC("ClearingParticipantSettlementAccount"), // Account used to post settlement debit and credit entries on behalf of
                                                // a designated Clearing Participant
  ...
  SACC("Settlement"), // Account used to post debit and credit entries, as a result of transactions
  ...
  TRAN("TransactingAccount"), // A transacting account is the most basic type of bank account that you can
                              // get. The main difference between transaction and cheque accounts
  // is that you usually do not get a cheque book with your transacting account
  // and neither are you offered an overdraft facility
