...
print_help()
{
	...
	printf 'Usage: %s [-q|--(no-)quiet] [-v|--(no-)verbose] [-s|--(no-)snapshots] [-h|--help] <release-version> [<snapshot-version>]\n' "$0"
	printf '\t%s\n' "<release-version>: Current release version, i.e. 1.2.0"
...
{
	local _required_args_string="'release-version'"
...
assign_positional_args()
{
	...
	_positional_names="_arg_release_version _arg_snapshot_version "
