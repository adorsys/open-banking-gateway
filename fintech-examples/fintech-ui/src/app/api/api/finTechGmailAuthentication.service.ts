...
export class FinTechGmailAuthenticationService {
    ...
    /**
     * Identifies the PSU in the Realm of the FinTechApi using his Gmail account.
     ...
     */
    public oauthLoginPOST(xRequestID: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public oauthLoginPOST(xRequestID: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public oauthLoginPOST(xRequestID: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public oauthLoginPOST(xRequestID: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/v1/oauth2/gmail/login`,
            null,
            {
