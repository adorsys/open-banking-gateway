...
export interface AisAccountAccessInfo {
     ...
     */
    allPsd2?: AisAccountAccessInfo.AllPsd2Enum;
    /**
     * Consent on all available accounts of psu
     */
    availableAccounts?: AisAccountAccessInfo.AvailableAccountsEnum;
    /**
     * Access to balances
     */
...
export namespace AisAccountAccessInfo {
    export type AllPsd2Enum = 'ALL_ACCOUNTS' | 'ALL_ACCOUNTS_WITH_BALANCES';
    export const AllPsd2Enum = {
        ACCOUNTS: 'ALL_ACCOUNTS' as AllPsd2Enum,
        ACCOUNTSWITHBALANCES: 'ALL_ACCOUNTS_WITH_BALANCES' as AllPsd2Enum
    };
    export type AvailableAccountsEnum = 'ALL_ACCOUNTS' | 'ALL_ACCOUNTS_WITH_BALANCES';
    export const AvailableAccountsEnum = {
        ACCOUNTS: 'ALL_ACCOUNTS' as AvailableAccountsEnum,
        ACCOUNTSWITHBALANCES: 'ALL_ACCOUNTS_WITH_BALANCES' as AvailableAccountsEnum
    };
}
