...
public class FintechStagesUtils {
    ...
    public static final String MAX_MUSTERMAN_ID = "oN7KTVuJSVotMvPPPavhVo";
    ...
    public static final String BANKSEARCH_LOGIN = "https://obg-dev-fintechui.cloud.adorsys.de/login";
