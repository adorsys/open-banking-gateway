...
public class TppAisClientFeignMock implements TppAisClient {
    ...
    @Override
    public ResponseEntity<AccountList> getAccounts(String authorization, String fintechUserID, String fintechRedirectURLOK, String fintechRedirectURLNOK, UUID xRequestID, String bankID, String psUConsentSession, UUID serviceSessionID) {
        return null;
    }
