...
public class FinTechListAccountsTest extends FinTechBankSearchApiTest {
    ...
    List<String> listAccountsForOk(BankProfileTestResult result) {
        when(tppAisClientFeignMock.getAccounts(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
    ...
    public void testListAccountsFor303() {
        ...
        verify(tppAisClientFeignMock, never()).getAccounts(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any());
    }
    ...
    public void testListAccountsFor303NoConsentSupport() {
        ...
        verify(tppAisClientFeignMock).getAccounts(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any());
    }
