 ...
 */
export type ScaStatus = 'received' | 'psuIdentified' | 'psuAuthenticated' | 'scaMethodSelected' | 'started' | 'finalised' | 'failed' | 'exempted';

export const ScaStatus = {
    Received: 'received' as ScaStatus,
    PsuIdentified: 'psuIdentified' as ScaStatus,
    PsuAuthenticated: 'psuAuthenticated' as ScaStatus,
    ScaMethodSelected: 'scaMethodSelected' as ScaStatus,
    Started: 'started' as ScaStatus,
    Finalised: 'finalised' as ScaStatus,
    Failed: 'failed' as ScaStatus,
    Exempted: 'exempted' as ScaStatus
};
