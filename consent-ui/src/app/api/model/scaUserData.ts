...
export namespace ScaUserData {
    export type ScaMethodEnum = 'EMAIL' | 'MOBILE' | 'CHIP_OTP' | 'PHOTO_OTP' | 'PUSH_OTP' | 'SMS_OTP' | 'APP_OTP';
    export const ScaMethodEnum = {
        EMAIL: 'EMAIL' as ScaMethodEnum,
        MOBILE: 'MOBILE' as ScaMethodEnum,
        CHIPOTP: 'CHIP_OTP' as ScaMethodEnum,
        PHOTOOTP: 'PHOTO_OTP' as ScaMethodEnum,
        PUSHOTP: 'PUSH_OTP' as ScaMethodEnum,
        SMSOTP: 'SMS_OTP' as ScaMethodEnum,
        APPOTP: 'APP_OTP' as ScaMethodEnum
    };
}
