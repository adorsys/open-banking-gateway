...
export type BalanceType = 'CLOSING_BOOKED' | 'EXPECTED' | 'AUTHORISED' | 'OPENING_BOOKED' | 'INTERIM_AVAILABLE' | 'FORWARD_AVAILABLE' | 'NONINVOICED';

export const BalanceType = {
    CLOSINGBOOKED: 'CLOSING_BOOKED' as BalanceType,
    EXPECTED: 'EXPECTED' as BalanceType,
    AUTHORISED: 'AUTHORISED' as BalanceType,
    OPENINGBOOKED: 'OPENING_BOOKED' as BalanceType,
    INTERIMAVAILABLE: 'INTERIM_AVAILABLE' as BalanceType,
    FORWARDAVAILABLE: 'FORWARD_AVAILABLE' as BalanceType,
    NONINVOICED: 'NONINVOICED' as BalanceType
};
