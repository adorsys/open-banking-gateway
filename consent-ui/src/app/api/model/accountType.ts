...
export type AccountType = 'CACC' | 'CASH' | 'CHAR' | 'CISH' | 'COMM' | 'CPAC' | 'LLSV' | 'LOAN' | 'MGLD' | 'MOMA' | 'NREX' | 'ODFT' | 'ONDP' | 'OTHR' | 'SACC' | 'SLRY' | 'SVGS' | 'TAXE' | 'TRAN' | 'TRAS';

export const AccountType = {
    CACC: 'CACC' as AccountType,
    CASH: 'CASH' as AccountType,
    CHAR: 'CHAR' as AccountType,
    CISH: 'CISH' as AccountType,
    COMM: 'COMM' as AccountType,
    CPAC: 'CPAC' as AccountType,
    LLSV: 'LLSV' as AccountType,
    LOAN: 'LOAN' as AccountType,
    MGLD: 'MGLD' as AccountType,
    MOMA: 'MOMA' as AccountType,
    NREX: 'NREX' as AccountType,
    ODFT: 'ODFT' as AccountType,
    ONDP: 'ONDP' as AccountType,
    OTHR: 'OTHR' as AccountType,
    SACC: 'SACC' as AccountType,
    SLRY: 'SLRY' as AccountType,
    SVGS: 'SVGS' as AccountType,
    TAXE: 'TAXE' as AccountType,
    TRAN: 'TRAN' as AccountType,
    TRAS: 'TRAS' as AccountType
};
