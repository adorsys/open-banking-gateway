...
@Service
public class ListTransactionsService extends FacadeRequireAuthorizationInNoAspspPsuKeyService<ListTransactionsRequest, TransactionsResponseBody, ListTransactions> {
